...
namespace Dungeons3D
{
	...
	{
		m_smallGimbal.Load("Meshes/SmallGimbal.mesh");
		m_mediumGimbal.Load("Meshes/MediumGimbal.mesh");
		m_largeGimbal.Load("Meshes/LargeGimbal.mesh");
		m_katana.Load("Meshes/katana.3DS");
		m_plane.Load("Meshes/UnitPlane.mesh");
